    ...
    >
      <el-row>
        ...
        >
          ...
          <AccountQuery ref="accountQuery" :appendToBody="true" :isIntisledge="true" :isLastLevel="true" @onGetData="getCheckData"></AccountQuery>
...
export default {
  ...
  methods: {
    ...
    btnClearable() {
      this.editFormData.ledgerdetailid = ''
