...
import conditionDialog from '@/views/ureport/trialBalance/conditionDialog'
...
export default {
  ...
  methods: {
    ...
    getQueryPeriods(data) {
      ...
      this.src = this.baseURL + '/ureport/preview?_u=' + 'mysql-provider-trialBalance.ureport.xml'
        + '&period=' + data.period
        + '&intstatus=' + data.bookStatus  + '&now=' + now + '&companyId=' + companyId
