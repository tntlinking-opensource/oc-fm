...
import conditionDialog from '@/views/ureport/generalLedger/conditionDialog'
...
export default {
  ...
  methods: {
    ...
    getQueryPeriods(data) {
      ...
      this.src = this.baseURL + '/ureport/preview?_u=' + 'mysql-provider-generalLedger.ureport.xml'
