...
import conditionDialog from '@/views/ureport/accountBalance/conditionDialog'
...
export default {
  ...
  methods: {
    ...
    getQueryPeriods(data) {
      ...
      this.src = this.baseURL + '/ureport/preview?_u=' + 'mysql-provider-accountBalance.ureport.xml'
        ...
        + now +'&isseveral='+data.isseveral+'&uqcompanyid='+data.companyValue
