...
import conditionDialog from '@/views/ureport/accountingBook/conditionDialog'
...
export default {
  ...
  methods: {
    ...
    getQueryPeriods(data) {
      ...
      this.src = this.baseURL + '/ureport/preview?_u=' + 'mysql-provider-accountingBook.ureport.xml' + '&tenant_id=' + currentUser.company.id
        + '&startPeriod=' + data.startPeriod + '&endPeriod=' + data.endPeriod + '&startHkont=' + startHkont + '&endHkont=' + endHkont
        + '&intstatus=' + data.bookStatus + '&summary=' + data.abstract + '&vcSelect=' + data.startAmount + '&endSelect=' + data.endAmount
