...
public class TfamCategoryOld extends DataEntity<TfamCategoryOld> {

    private static final long serialVersionUID = 1641034040897358519L;
    ...
    // 构造方法
    public TfamCategoryOld() {
        super();
    }

    public TfamCategoryOld(String id) {
        super(id);
    }
