...
public class TfamCategoryEntry extends DataEntity<TfamCategoryEntry> {

    private static final long serialVersionUID = 1641034040897358090L;
    ...
    private String imagebase64; // 存图片文件

    // 构造方法
    public TfamCategoryEntry() {
        super();
    }

    public TfamCategoryEntry(String id) {
        super(id);
    }
    ...
    @Length(min = 0, max = -1, message = "存图片文件长度必须介于 0 和 -1 之间")
