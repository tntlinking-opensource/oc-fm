...
public class TfamAssetOld extends DataEntity<TfamAssetOld> {

    private static final long serialVersionUID = 1641034040897358518L;
    ...
    private String nature = "1"; // tfam_nature 卡片性质（1待新增制证，2已新增制证，3待减少制证，4已减少制证）

    private TfamCategoryOld category; // tfam_category 资产类别（资产类别表id）
    ...
    private String usedeptid; // org_department 使用部门（部门id）

    private SysUserOld userid; // sys_user 责任人（用户id）

    private Integer num; // 数量

    private String unit; // 计量单位（手动输入）

    private TfamUsingstatusOld usingstatus; // tfam_usingstatus 使用状况（1使用中，2未使用，3不需用，4经营性租出，5愈龄，7损坏需维修，8设备已外。借，9设备待报废，10损坏丢失）
    ...
    private TfamDepmethodOld depmethod; // tfam_depmethod  折旧方法（资产类别表depmethod）
    ...
    private String addReason; // tfam_change_way  新增原因（变动方式表id）

    private SysUserOld createrid; // 创建人id
    ...
    private SysUserOld employeeno; // 负责人工号
    ...
    private List<TfamCategoryOld> tfamCategoryOldList = Lists.newArrayList(); // 子表列表

    private List<TfamUsingstatusOld> tfamUsingstatusOldList = Lists.newArrayList(); // 子表列表

    private List<SysUserOld> sysUserOldList = Lists.newArrayList(); // 子表列表

    private List<TfamDepmethodOld> tfamDepmethodOldList = Lists.newArrayList(); // 子表列表
    ...
    @Length(
        min = 1,
        max = 11,
        message = "tfam_nature 卡片性质（1待新增制证，2已新增制证，3待减少制证，4已减少制证）长度必须介于 1 和 11 之间"
    )
    ...
    public TfamCategoryOld getCategory() {
        return category;
    }

    public void setCategory(TfamCategoryOld category) {
    ...
    @Length(min = 0, max = 100, message = "org_department 使用部门（部门id）长度必须介于 0 和 100 之间")
    ...
    public SysUserOld getUserid() {
        return userid;
    }

    public void setUserid(SysUserOld userid) {
        this.userid = userid;
    }
    ...
    public TfamUsingstatusOld getUsingstatus() {
        return usingstatus;
    }

    public void setUsingstatus(TfamUsingstatusOld usingstatus) {
    ...
    public TfamDepmethodOld getDepmethod() {
        return depmethod;
    }

    public void setDepmethod(TfamDepmethodOld depmethod) {
    ...
    @Length(min = 0, max = 100, message = "tfam_change_way  新增原因（变动方式表id）长度必须介于 0 和 100 之间")
    ...
    public SysUserOld getCreaterid() {
        return createrid;
    }

    public void setCreaterid(SysUserOld createrid) {
    ...
    public SysUserOld getEmployeeno() {
        return employeeno;
    }

    public void setEmployeeno(SysUserOld employeeno) {
    ...
    public List<TfamCategoryOld> getTfamCategoryOldList() {
        return tfamCategoryOldList;
    }

    public void setTfamCategoryOldList(List<TfamCategoryOld> tfamCategoryOldList) {
        this.tfamCategoryOldList = tfamCategoryOldList;
    }

    public List<TfamUsingstatusOld> getTfamUsingstatusOldList() {
        return tfamUsingstatusOldList;
    }

    public void setTfamUsingstatusOldList(List<TfamUsingstatusOld> tfamUsingstatusOldList) {
        this.tfamUsingstatusOldList = tfamUsingstatusOldList;
    }

    public List<SysUserOld> getSysUserOldList() {
        return sysUserOldList;
    }

    public void setSysUserOldList(List<SysUserOld> sysUserOldList) {
        this.sysUserOldList = sysUserOldList;
    }

    public List<TfamDepmethodOld> getTfamDepmethodOldList() {
        return tfamDepmethodOldList;
    }

    public void setTfamDepmethodOldList(List<TfamDepmethodOld> tfamDepmethodOldList) {
        this.tfamDepmethodOldList = tfamDepmethodOldList;
    }
