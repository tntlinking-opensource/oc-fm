...
public class OrgDepartmentEntry extends DataEntity<OrgDepartmentEntry> {

    private static final long serialVersionUID = 1641034040897358088L;
    ...
    // 构造方法
    public OrgDepartmentEntry() {
        super();
    }

    public OrgDepartmentEntry(String id) {
        super(id);
    }
