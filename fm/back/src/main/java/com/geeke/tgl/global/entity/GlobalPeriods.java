package com.geeke.tgl.global.entity;
...
public class GlobalPeriods extends DataEntity<GlobalPeriods> {

    private static final long serialVersionUID = 1457254743943430269L;
    ...
    // 构造方法
    public GlobalPeriods() {
        super();
    }

    public GlobalPeriods(String id) {
        super(id);
    }
