...
@ApiModel
public class GroupAccountsEntityTree extends TreeEntity<GroupAccountsEntityTree> {
    ...
    private GroupAccountsEntityTree uqparentid;		//父级ID
    ...
    public GroupAccountsEntityTree()
    {
        super();
    }
    @Override
    ...
    public GroupAccountsEntityTree getUqparentid() {
        return uqparentid;
    }

    public void setUqparentid(GroupAccountsEntityTree uqparentid) {
    ...
    public GroupAccountsEntityTree(String id,String uqaccountid, String uqaccountsetid,
                                   ...
                                   String uqpreaccountid, GroupAccountsEntityTree uqparentid, String intislastlevel,
