...
public class TglAccountsTree extends TreeEntity<TglAccountsTree> {
    ...
    private TglAccountsTree uqparentid; // 父级科目ID
    ...
    // 构造方法
    public TglAccountsTree() {
        super();
    }

    public TglAccountsTree(String id) {
        super(id);
    }
    ...
    public TglAccountsTree getUqparentid() {
        return uqparentid;
    }

    public void setUqparentid(TglAccountsTree uqparentid) {
