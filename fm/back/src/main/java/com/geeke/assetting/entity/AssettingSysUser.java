...
public class AssettingSysUser extends DataEntity<AssettingSysUser> {

    private static final long serialVersionUID = 1641034040897356568L;

    private String companyId; // 公司

    private AssettingOrgDepartment department; // 部门
    ...
    // 构造方法
    public AssettingSysUser() {
        super();
    }

    public AssettingSysUser(String id) {
        super(id);
    }
    ...
    public AssettingOrgDepartment getDepartment() {
        return department;
    }

    public void setDepartment(AssettingOrgDepartment department) {
