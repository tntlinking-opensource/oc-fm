...
public class LeaveController extends BaseController {
    ...
    public ResponseEntity<JSONObject> saveDraft(@RequestParam("strDraft") String strDraft, @RequestParam("strEntity") String strEntity, @RequestParam(value = "attachments",required = false) MultipartFile[] attachments  ) throws java.io.IOException {
    ...
    public ResponseEntity<JSONObject> create(@PathVariable("procDefId") String procDefId, @RequestParam("strEntity") String strEntity, @RequestParam(value = "attachments",required = false) MultipartFile[] attachments  ) throws java.io.IOException {
        Leave entity = JSONObject.parseObject(strEntity, Leave.class);
    ...
    public ResponseEntity<JSONObject> reapply(@PathVariable("taskId") String taskId, @RequestParam("strEntity") String strEntity, @RequestParam(value = "attachments",required = false) MultipartFile[] attachments ) throws java.io.IOException {
        Leave entity  = JSONObject.parseObject(strEntity, Leave.class);
    ...
    public ResponseEntity<JSONObject> agree(@PathVariable("taskId") String taskId, @RequestParam("strEntity") String strEntity, @RequestParam(value = "attachments",required = false) MultipartFile[] attachments ) throws java.io.IOException {
        Leave entity  = JSONObject.parseObject(strEntity, Leave.class);
    ...
    public ResponseEntity<JSONObject> forward(@PathVariable("taskId") String taskId, @RequestParam("strEntity") String strEntity, @RequestParam(value = "attachments",required = false) MultipartFile[] attachments ) throws java.io.IOException {
        Leave entity  = JSONObject.parseObject(strEntity, Leave.class);
    ...
    public ResponseEntity<JSONObject> commission(@PathVariable("taskId") String taskId, @RequestParam("strEntity") String strEntity, @RequestParam(value = "attachments",required = false) MultipartFile[] attachments ) throws java.io.IOException {
        Leave entity  = JSONObject.parseObject(strEntity, Leave.class);
    ...
    public ResponseEntity<JSONObject> propose(@PathVariable("taskId") String taskId, @RequestParam("strEntity") String strEntity, @RequestParam(value = "attachments",required = false) MultipartFile[] attachments ) throws java.io.IOException {
        Leave entity  = JSONObject.parseObject(strEntity, Leave.class);
    ...
    public ResponseEntity<JSONObject> back(@PathVariable("taskId") String taskId, @RequestParam("strEntity") String strEntity, @RequestParam(value = "attachments",required = false) MultipartFile[] attachments ) throws java.io.IOException {
        Leave entity  = JSONObject.parseObject(strEntity, Leave.class);
    ...
    public ResponseEntity<JSONObject> reject(@PathVariable("taskId") String taskId, @RequestParam("strEntity") String strEntity, @RequestParam(value = "attachments",required = false) MultipartFile[] attachments ) throws java.io.IOException {
        Leave entity  = JSONObject.parseObject(strEntity, Leave.class);
    ...
    public ResponseEntity<JSONObject> terminate(@PathVariable("taskId") String taskId, @RequestParam("strEntity") String strEntity, @RequestParam(value = "attachments",required = false) MultipartFile[] attachments ) throws java.io.IOException {
        Leave entity  = JSONObject.parseObject(strEntity, Leave.class);
